...
function downloadBundle(event, kind) {
  ...
  if (!urls) return;
  // Download both tree and alignment using two synchronous clicks.
  // setTimeout was unreliable across browsers.
  triggerDownload(urls.tree);
  triggerDownload(urls.alignment);
}
