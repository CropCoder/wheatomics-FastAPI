...
VARIANTHUB_DATASETS: dict[str, dict[str, str]] = {
    ...
    "whealbi_minocc10": {
        ...
        "source": "Whealbi panel (imputed)",
        "reference": "Chinese_Spring1.0",
        "url": "https://urgi.versailles.inrae.fr/download/iwgsc/IWGSC_RefSeq_Annotations/v1.0/",
    },
    "Aus_UG_eff": {
        "label": "Aus.UG.eff",
        "filename": "Aus.UG.dedup.whole.eff.vcf.gz",
        "source": "Hexaploid bread wheat pangenome (PMID 28231383)",
        "reference": "Chinese_Spring1.0",
        "url": "https://pubmed.ncbi.nlm.nih.gov/28231383/",
    },
    "Exon_dedup_HCandUG": {
        "label": "Exon.dedup.HCandUG",
        "filename": "Exom.dedup.HCandUG.eff.vcf.gz",
        "source": "Exome HC+UG, deduplicated",
        "reference": "Chinese_Spring1.0",
        "url": "https://www.ncbi.nlm.nih.gov/pubmed/25886949",
    },
    "PRJNA381058_exome": {
        "label": "PRJNA381058_exome",
        "filename": "PRJNA381058_exome_whole_eff.vcf.gz",
        "source": "Exome capture (recombination study)",
        "reference": "Chinese_Spring1.0",
        "url": "https://www.ncbi.nlm.nih.gov/pmc/articles/PMC617499/",
    },
    "Exome_PRJEB30905": {
        "label": "Exome_PRJEB30905",
        "filename": "Exome_PRJEB30905_whole_eff.vcf.gz",
        "source": "VRN1 and developmental response (PRJEB30905)",
        "reference": "Chinese_Spring1.0",
        "url": "https://doi.org/10.1242/dev.172684",
    },
    "1000_wheat_exomes": {
    ...
    "1000_wheat_exomes_imputed": {
        ...
        "source": "1kEC, imputed and filtered",
        "reference": "Chinese_Spring1.0",
        "url": "https://www.ncbi.nlm.nih.gov/bioproject/PRJNA517692",
    },
    "NewExomeCapute": {
        ...
        "source": "New exome capture (GigaScience 2019)",
        "reference": "Chinese_Spring1.0",
        "url": "https://academic.oup.com/gigascience/article/8/4/giz018/5304888",
    },
    "90_mini_core_rna_seq_HC": {
        "label": "90_mini_core_rna_seq_HC",
        "filename": "90_mini_core_rna_seq_whole.eff.vcf.gz",
        "source": "90 mini-core accessions RNA-seq (PMC5619896)",
        "reference": "Chinese_Spring1.0",
        "url": "https://pmc.ncbi.nlm.nih.gov/articles/PMC5619896/",
    },
    "355_common_wheat_WGS": {
        "label": "355 common wheat WGS",
        "filename": "all355.maf01.mis25.het03.eff.vcf.gz",
        "source": "355 common wheat WGS, integrated (Plant Cell 2023)",
        "reference": "Chinese_Spring1.0",
        "url": "https://doi.org/10.1093/plcell/koad229",
    },
    "Vmap_1.0": {
        "label": "Vmap 1.0",
        "filename": "414WGS.vcf.eff.vcf.gz",
        "source": "VMap 1.0 panel (414 WGS, Nat Genet 2020)",
        "reference": "Chinese_Spring1.0",
        "url": "https://www.nature.com/articles/s41588-020-00722-w",
    },
    "35_grain_rna_seq_HC": {
        "label": "35_grain_rna_seq_HC",
        "filename": "35_grain_rna_seq_whole.eff.vcf.gz",
        "source": "35 grain RNA-seq accessions (PMC5637334)",
        "reference": "Chinese_Spring1.0",
        "url": "https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5637334/",
    },
    "GBS_filtered_SNPs": {
        "label": "GBS_filtered_SNPs",
        "filename": "GBS_filtered_SNPs_IWGSCv1.0.eff.vcf.gz",
        "source": "GBS SNPs, filtered",
        "reference": "Chinese_Spring1.0",
        "url": "https://pubmed.ncbi.nlm.nih.gov/25886949/",
    },
    "GBS_filtered_Indels": {
    ...
    "GBS_NG_GWAS": {
        ...
        "source": "GBS NG GWAS panel (Nat Genet 2019)",
        "reference": "Chinese_Spring1.0",
        "url": "https://www.nature.com/articles/s41588-019-0496-6",
    },
    "commonwheat63WGS": {
        "label": "commonwheat63WGS",
        "filename": "commonwheat63WGS.eff.sort.filter.vcf.gz",
        "source": "Common wheat, 63 WGS (PMID 30081829)",
        "reference": "Chinese_Spring1.0",
        "url": "https://pubmed.ncbi.nlm.nih.gov/30081829/",
    },
    "WildEmmer20WGS_SNP": {
        "label": "WildEmmer20WGS_SNP",
        "filename": "WildEmmer20WGS_SNP_eff.vcf.gz",
        "source": "Wild emmer, 20x WGS SNPs",
        "reference": "Chinese_Spring1.0",
        "url": "https://www.ncbi.nlm.nih.gov/pubmed/31300020",
    },
    "WildEmmer10WGS_INDEL": {
        "label": "WildEmmer10WGS_INDEL",
        "filename": "WildEmmer10WGS_INDEL_eff.vcf.gz",
        "source": "Wild emmer, 10x WGS InDels",
        "reference": "Chinese_Spring1.0",
        "url": "https://www.ncbi.nlm.nih.gov/pubmed/31300020",
    },
    "SHW_GBS_SNP": {
        ...
        "source": "Synthetic hexaploid wheat (SHW) GBS SNPs",
        "reference": "Chinese_Spring1.0",
        "url": "https://www.ncbi.nlm.nih.gov/pubmed/30081829/",
    },
    "Cheng_2024": {
        ...
        "source": "Cheng et al. 2024, integrated SNPs (Nature 2024)",
        "reference": "Chinese_Spring1.0",
        "url": "https://www.nature.com/articles/s41586-024-07682-9",
    },
    "287exome_CS2.1": {
        ...
        "url": "https://doi.org/10.1016/j.molp.2022.01.004",
    },
    "wheat660k_2191_CS2.1": {
        ...
        "reference": "Chinese_Spring2.1",
        "url": "https://www.nature.com/articles/s41588-025-02259-2",
    },
    "all491_cnv_snp_indel": {
        ...
        "reference": "Chinese_Spring1.0",
        "url": "https://linkinghub.elsevier.com/retrieve/pii/S2590346224006473",
    },
