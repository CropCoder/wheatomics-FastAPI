...
class Settings(BaseSettings):
    ...
    ORTHOFINDER_BASE_DIR: Path = Path("/var/www/html/orthefind/Results_Jul24")
    ORTHOFINDER_CLUSTER_FILE: Path = Path("/var/www/html/orthefind/Results_Jul24/WorkingDirectory/SpeciesIDs_cluster.txt")
