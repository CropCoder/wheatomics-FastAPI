...
class Settings(BaseSettings):
    ...
    ORTHOFINDER_BASE_DIR: Path = Path("/var/www/html/orthefind/Results_Jun30")
    ORTHOFINDER_CLUSTER_FILE: Path = Path("/var/www/html/orthefind/Results_Jun30/Orthogroups/SpeciesIDs_cluster.txt")
